module github.com/cdoan1/mono-repo/tools

go 1.26.0

require (
	github.com/cdoan1/mono-repo/api v0.0.0
	github.com/cdoan1/mono-repo/sdk v0.0.0
...
replace (
	github.com/cdoan1/mono-repo/api => ../api
	github.com/cdoan1/mono-repo/sdk => ../sdk
)
